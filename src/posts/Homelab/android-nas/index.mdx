...
categories:
  - Homelab
cover: ./cover.avif
description: My personal practice of utilizing used Android Phone to lightweight NAS with AList and Cloudflare Tunnel.
---
...
### 2.1 P2P Hole Punching (Tailscale / ZeroTier)
...
#### 2.2.1 Register a Domain on Cloudflare
...
<Text type="rainbow">
  I highly recommend setting up a subdomain (e.g., pan.yourdomain.com) for the
  tunnel traffic instead of your root domain.
</Text>
...
#### 2.2.2 Installing cloudflared in Termux
...
#### 2.2.5 Routing DNS and Launching
...
## 3 Real-Time Hardware Monitoring via MacroDroid
...
### 3.2 AList Admin Setting Injection
